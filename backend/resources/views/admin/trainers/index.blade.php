...
@section("title-side")
<a href="{{asset('admin/trainers/create')}}"
...
@section("content")
<!-- <a href='{{route("trainers.create")}}' class='btn btn-success'>Create </a> -->
...
<table class="table table-striped table-sm mt-3">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <form method='post' action='{{asset("trainers/".$item->id)}}'>
                    @csrf
                    @method("delete")
                    <a href='{{ route("trainers.show",$item->id) }}' class='btn btn-sm btn-info'>عرض</a>
                    <a href='{{ route("trainers.edit",$item->id) }}' class='btn btn-sm btn-primary'>تعديل</a>
                    <!-- <input type='submit' onclick='return confirm("Are you sure?")' value='Delete'
                        class='btn btn-danger btn-sm ' /> -->
                    <a href='{{ route("trainers.delete",$item->id) }}' class='btn btn-danger btn-sm'
