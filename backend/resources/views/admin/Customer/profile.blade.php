...
@section("content")
    <div class="text-right mt-5 container" >
        <div class="card-body" style="margin-top: 120px;background-color: #d4eafe;">
            <div class="row">
                            ...
                            <div class="tab-pane active show" id="m_user_profile_tab_1">
                                <div class="m-portlet__body">
                                    ...
                                    <div class="row m-form">
                                        ...
                                        <div class="col-7">
                                            @if($user->gender == 'f')
                                                <label class="col-form-label">أنثى</label>
                                            @else
                            ...
                            <div class="tab-pane" id="m_user_profile_tab_2">
                                <form class="m-form m-form--fit" method="post" action="{{route('profile.update')}}"
                                    ...
                                    <div class="m-portlet__body">
                                        ...
                                        <div class="form-group m-form__group row">
                                            <label for="example-text-input" class="col-2 col-form-label"> الجنس:</label>
                                            <div class="col-7">
                                                <label class="col-1 col-form-label" for="f">
                                                    <input checked type="radio" value="f"
                                                           name="gender">أنثى</label>
                                                <label class="col-1 col-form-label" for="m"><input type="radio" value="m"
                                                                                                   name="gender">ذكر</label>
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
